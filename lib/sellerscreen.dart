...
import 'package:mainscreen/newproductscreen.dart';
...
//check permission,get location,get address return false if any problem.
  ...
  void _loadProducts() {
    ...
    http
        .get(
      Uri.parse(
          "${ServerConfig}/php/loadsellerproduct.php?userid=${widget.user.id}"),
    )
        .then((response) {
  ...
  void _deleteProduct(index) {
    try {
      http.post(Uri.parse("${ServerConfig}/php/delete_product.php"), body: {
